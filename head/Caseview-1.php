...
<br>
            <label>Contact Name </label> <label style="margin-left:20px;    ">Abdullah El Maraghy</label>
                ...
                <label style="left:150px;">Contact Email  </label> <label style="margin-left:200px;">Mohamed@gmail.com</label>
<br><br>
...
<label style="left:85px;">Final closed date  </label> <label style="margin-left:140px;">14/3/2021 14:05</label>
